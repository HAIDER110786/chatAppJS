...
function insertTheMsg(msg){
    ...
    <div style="background-color:#d3d3d3;width: fit-content;padding:10px;border-radius: 10px;font-family: sans-serif;max-width:inherit;">
        ${msg.msg}
    </div>
    <div style="display:flex;flex-direction:row;justify-content: flex-end;font-size: 12px;">
